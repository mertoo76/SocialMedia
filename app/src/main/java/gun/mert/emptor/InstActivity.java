    ...
    private Handler handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            if (msg.what == InstagramApp.WHAT_FINALIZE) {
                ...
                Toast.makeText(InstActivity.this, "Check your network.",
...
// userInfoHashmap = mApp.
        ...
        //        displayInfoDialogView();
            ...
            public void onFail(String error) {
                Toast.makeText(InstActivity.this, error, Toast.LENGTH_SHORT).show();
            }
        });
...
// btnConnect.setVisibility(View.VISIBLE);
    ...
    private void displayInfoDialogView() {
        ...
        new gun.mert.emptor.ImageLoader(InstActivity.this).DisplayImage(
